<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuOf.aspx.cs" Inherits="Proyecto_AdmBD.MenuOf" %>
...
<body>
    ...
    <form id="form3" runat="server">
        ...
        <!-- Navigation Bar -->
        <div class="navbar">
            <a href="MiPerfilOf.aspx">Perfil Oferente</a>
            <a href="VerSolicitudes.aspx">Ver Solicitudes</a>
            <a href="CalificarCliente.aspx">Calificar Cliente</a>
        </div>
